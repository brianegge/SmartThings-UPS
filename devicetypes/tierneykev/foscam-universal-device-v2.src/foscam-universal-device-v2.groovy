 ...
 */
metadata {
	definition (name: "Foscam Universal Device V2", namespace: "tierneykev", author: "Kevin Tierney") {
		capability "Polling"
...
def alarmOn() {
    ...
    if(hdcamera == "true") {
		hubGet("cmd=setMotionDetectConfig&isEnable=1&linkage=14&snapInterval=2&sensitivity=2&triggerInterval=5&schedule0=281474976710655&schedule1=281474976710655&schedule2=281474976710655&schedule3=281474976710655&schedule4=281474976710655&schedule5=281474976710655&schedule6=281474976710655&area0=0&area1=7&area2=775&area3=775&area4=0&area5=0&area6=0&area0=1&area8=0&area9=0")        //hubGet("cmd=setMotionDetectConfig&isEnable=1")
    }
    else {
